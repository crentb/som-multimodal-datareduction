...
| `crys` | float | **feature** | Raman crystallinity marker (inverse phosphate nu1 peak width). |
| `fluo` | float | **feature** | Raman fluorescence / background position (~960 cm^-1 region). |
